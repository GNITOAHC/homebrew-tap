...
puts "Releasing codesfer on Homebrew: v#{version}"

url = "https://api.github.com/repos/gnitoahc/codesfer/releases/tags/v#{version}"
...
release_file = ""
File.open("Formula/codesfer.rb", "r") do |file|
...
File.write("Formula/codesfer.rb", release_file)
puts "Saved Formula/codesfer.rb, Done"
