...
puts "Releasing queue on Homebrew: v#{version}"

url = "https://api.github.com/repos/gnitoahc/processq/releases/tags/v#{version}"
...
release_file = ""
File.open("Formula/queue.rb", "r") do |file|
...
File.write("Formula/queue.rb", release_file)
puts "Saved Formula/queue.rb, Done"
